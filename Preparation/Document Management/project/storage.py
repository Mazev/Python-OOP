class Storage:
    ...
    def __repr__(self):
        return f"{self.categories}, {self.topics}, {self.documents}"
    ...
    def delete_category(self, category_id):
        filtred_category = [c for c in self.categories if c.id == category_id][0]
        filtred_category.remove(category_id)
    ...
    def get_document(self, document_id):
        get_doc = [d for d in self.documents if d.id == document_id]
        return get_doc
